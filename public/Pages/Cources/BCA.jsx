    ...
    <>
      <div className='md:px-10 py-10'>
        ...
        <div className='flex flex-col gap-5 items-center justify-center md:flex md:flex-row md:justify-center md:gap-22 md:items-center'>
          ...
          <div>
            <h1 className='text-center text-3xl md:text-5xl font-bold pb-1.5'>BCA
              <span className='text-lg md:text-3xl'> (Bachelor in Computer Application)</span>
            </h1>
            <p>
              Explore the science behind computers, algorithms, and problem-solving. <br />
              Build analytical and programming skills for tomorrow's challenges.
            </p>
          </div>
        </div>
