      ...
      <div className='md:px-10 py-10'>
        ...
        <div className='flex flex-col gap-5 items-center justify-center md:flex md:flex-row md:justify-center md:gap-22 md:items-center'>
          <div className='h-52 w-46  flex items-center justify-center'>
            <img className='h-52 w-46 overflow-hidden rounded-2xl ' src={BoyLogo} alt="laoding..." />
          </div>
          <div>
            ...
            <p>
              Go deep into the science of computation and algorithm optimization. <br />
              Designed for research-driven minds to solve complex computing problems.
            </p>
          </div>
        </div>
