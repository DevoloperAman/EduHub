    ...
    <>
      ...
      <div className='md:px-10 py-10'>
        ...
        <div className='flex flex-col gap-5 items-center justify-center md:flex md:flex-row md:justify-center md:gap-22 md:items-center'>
          ...
          <div>
            <h1 className='text-center text-3xl md:text-5xl font-bold pb-1.5'>M.Sc.
              <span className='text-lg md:text-3xl'>  (Information Technology)</span> </h1>
            <p>
              Specialize in IT infrastructure, cybersecurity, and data analytics. <br />
              Build strategic technology solutions with practical IT skills.
            </p>
          </div>
        </div>
