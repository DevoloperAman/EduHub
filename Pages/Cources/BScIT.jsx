...
//           </div>
//           <div>
//             <h1 className='text-5xl font-bold pb-1.5'>B.Sc.
//               <span className='text-3xl'>  (Information Technology)</span> </h1>
//             <p>
//               Understand how information systems work in real-world environments. <br />
//               Gain practical skills in IT, networking, and web technologies.
//             </p>
//           </div>
//         </div>
...
//         <div className=' h-42 overflow-y-scroll scroll-smooth  p-4 rounded-lg shadow-lg bg-white'>
  ...
  return (
    <div className='px-6 py-10'>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-12'>
        <img
          src="src/assets/Cources pages images/Bscit.jpg"
          alt="BScIT"
          className='h-52 w-52 rounded-2xl object-cover'
        />
        <div className='text-center md:text-left'>
          <h1 className='text-5xl font-bold mb-2'>
            B.Sc. <span className='text-3xl'>(Information Technology)</span>
          </h1>
      ...
      <div className='flex justify-center items-center gap-4 mb-10'>
        <input
          type="text"
          placeholder='Search your Subject...'
          className='w-4/5 md:w-3/5 px-6 py-3 border rounded-2xl text-lg shadow-sm'
          value={search}
          onChange={(e) => setSearch(e.target.value)}
        />
        <i className="fa-brands fa-searchengin fa-shake text-4xl text-blue-500"></i>
      </div>

      {/* Subject Grid */}
      <div className='max-h-[400px] overflow-y-auto bg-white rounded-xl shadow-md p-6'>
          ...
          {filteredSubjects.length > 0 ? (
            filteredSubjects.map((subject, index) => (
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='w-full text-center border shadow-md px-4 py-3 rounded-lg font-medium hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out'
              >
                {subject.name}
              </a>
            ))
