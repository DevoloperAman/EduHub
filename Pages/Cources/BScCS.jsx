...
//               <span className='text-3xl'>  (Computer Science)</span> </h1>
//             <p>
//               Dive into the foundations of computer science and software design. <br />''
//               Learn programming, data management, and the logic behind technolo
//             </p>
//           </div>
//         </div>
  ...
  return (
    <div className='md:px-10 py-10'>
      ...
      <div className='flex flex-col gap-5 items-center justify-center md:flex md:flex-row md:justify-center md:gap-22 md:items-center'>
        <div className='h-52 w-46 flex items-center justify-center'>
          <img className='h-52 w-46 overflow-hidden rounded-2xl hidden md:block' src="src/assets/Cources pages images/Bscit.jpg" alt="loading..." />
          <img className='h-52 w-82 overflow-hidden rounded-full md:hidden' src="src/assets/Cources pages images/Boy simple.png" alt="loading..." />
        </div>
        <div>
          <h1 className='text-center text-3xl md:text-5xl font-bold pb-1.5'>B.Sc.
            <span className='text-lg md:text-3xl'> (Computer Science)</span>
          </h1>
          <p className='text-center md:text-left'>
            Dive into the foundations of computer science and software design. <br />
            Learn programming, data management, and the logic behind technology.
          </p>
        </div>
      </div>
          ...
          {filteredSubjects.length > 0 ? (
            filteredSubjects.map((Subject, index) => (
              <a
                ...
                key={index}
                className='border-1 shadow-xl w-28 h-14 rounded-md px-2 flex justify-center items-center text-center font-semibold 
                hover:bg-blue-500 hover:text-white hover:font-bold transition-all duration-500 ease-in-out'
              >
                {Subject.name}
              </a>
            ))
